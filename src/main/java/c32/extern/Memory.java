...
// todo: возможность определять, находится ли объект в metaspace
//  (metaspace относится к native памяти и не собирается сборщиком мусора, в нём все статические переменные и метаданные)
// todo 2: migrate to memapi3
public class Memory {
